...
return array (
    ...
    \TYPO3\CMS\Core\Site\Set\SetDefinition::__set_state(array(
      ...
      array (
        ...
        \TYPO3\CMS\Core\Settings\SettingDefinition::__set_state(array(
           ...
           'enum' => 
          array (
            'theme-caramel-cream' => 'Caramel Cream',
            'theme-ocean-breeze' => 'Ocean Breeze',
            'theme-forest-mist' => 'Forest Mist',
            'theme-violet-velvet' => 'Violet Velvet',
          ),
           'category' => 'camino',
           'tags' => 
          array (
  ...
  'invalidSets' => 
  array (
    'wih-cement/wih-cement' => 
    array (
      'error' => 
      \TYPO3\CMS\Core\Site\Set\SetError::invalidSet,
      'name' => 'wih-cement/wih-cement',
      'context' => 'Invalid set definition: {"name":"wih-cement\\/wih-cement","label":"WIH Cement","sets":["typo3\\/fluid-styled-content","typo3\\/seo","typo3\\/felogin"]} – Invalid properties: sets',
    ),
  ),
);
#